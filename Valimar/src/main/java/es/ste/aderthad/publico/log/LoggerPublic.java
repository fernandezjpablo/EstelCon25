...
public class LoggerPublic {
    ...
    public static void GenerarEntradaLogError(Exception e, String archivo) {
        ...
        try {
            if (!archivo_log.exists()) {
                File parentDir = archivo_log.getParentFile();
            ...
            System.out.println("Intentando escribir en el archivo de error: " + ruta); // Imprimir la ruta del archivo
    ...
    public static void GenerarEntradaLogMensaje(String mensaje, String archivo) {
        ...
        try {
            ...
            String ruta = archivo_log.getAbsolutePath();
            System.out.println("Intentando escribir en el archivo de mensaje: " + ruta); // Imprimir la ruta del archivo
            FileWriter fw = new FileWriter(ruta, true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter out = new PrintWriter(bw);
            out.println(sb.toString());
