...
public class MensajeBean {
	...
	public Message generarMensaje()
	{
		...
		prop.put("mail.smtp.host", EntornoInscritos.getVariable("SMTP_HOST"));
		prop.put("mail.smtp.auth","true");
		prop.put("mail.smtp.port", EntornoInscritos.getVariable("SMTP_PORT"));
		prop.put("mail.smtp.starttls.enable", EntornoInscritos.getVariable("SMTP_ENABLE_TLS"));
